  ...
  return (
    <Modal
      ...
      <Modal.Body>
        ...
        <Image src={props.image_d} fluid className="p-2" />
        <Image src={props.image_e} fluid className="p-2" />
        <Image src={props.image_f} fluid className="p-2" />

        <Image src={props.image_g} fluid className="p-2" />
        <Image src={props.image_h} fluid className="p-2" />
      </Modal.Body>
      <Modal.Footer>
